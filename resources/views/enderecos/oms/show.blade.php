...
@section('content_header')
    <h1>Cadastro de endereço de OM : {{ $om->nomeOm }} </h1>
@stop
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('oms.enderecos.edit', [$om->id, $endereco->id]) }}" method="post">
                @method('GET')
                {{ csrf_field() }}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="cep"
                                        ...
                                        id="cep" value="{{ $endereco->cep }}" disabled>
                                    @error('cep')
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="rua"
                                        ...
                                        id="rua" value="{{ $endereco->rua }}" disabled>
                                    @error('rua')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="numeroEndereco"
                                        ...
                                        name="numeroEndereco" id="numeroEndereco" value="{{ $endereco->numeroEndereco }}" disabled>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="complemento"
                                        ...
                                        name="complemento" id="complemento" value="{{ $endereco->complemento }}" disabled>
                                    @error('complemento')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="bairro"
                                        ...
                                        name="bairro" id="bairro" value="{{ $endereco->bairro }}" disabled>
                                    @error('bairro')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="cidade"
                                        ...
                                        name="cidade" id="cidade" value="{{ $endereco->cidade }}" disabled>
                                    @error('cidade')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="estado"
                                        ...
                                        name="estado" id="estado" value="{{ $endereco->estado }}" disabled>
                                    @error('estado')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
